...
TCB_threshold_fun<-function(GA,Days,Hours){
  if (is.na(GA)|is.na(Days)|is.na(Hours)){
    ...
    result<-TSB("P0","34 weeks",Days,Hours)
  }
  else if (GA==33) {
    result<-TSB("P0","33 weeks",Days,Hours)
  }
  else if (GA==32) {
    result<-TSB("P0","32 weeks",Days,Hours)
  }
  else if (GA==31) {
    result<-TSB("P0","31 weeks",Days,Hours)
  }
  else if (GA==30) {
    result<-TSB("P0","30 weeks",Days,Hours)
  }
  else if (GA==29) {
    result<-TSB("P0","29 weeks",Days,Hours)
  }
  else if (GA==28) {
    result<-TSB("P0","28 weeks",Days,Hours)
  }
  else if (GA==27) {
    result<-TSB("P0","27 weeks",Days,Hours)
  }
  else if (GA==26) {
    result<-TSB("P0","26 weeks",Days,Hours)
  }
  else if (GA==25) {
    result<-TSB("P0","25 weeks",Days,Hours)
  }
  else if (GA==24) {
    result<-TSB("P0","24 weeks",Days,Hours)
  }
  else if (GA==23) {
    result<-TSB("P0","23 weeks",Days,Hours)
  }
  else {
    result<-NA
  }
...
excel_fun<-function(data){
  #Birth outcome
  result_15_NICE_birth<-result_fun(data,"TCB_threshold_birth_outcome_ind","TCB_15_birth_outcome_ind","TcB >= 15","TcB < 15","TcB >= NICE threshold","TcB < NICE threshold")
  result_Jaund_NICE_birth<-result_fun(data,"TCB_threshold_birth_outcome_ind","M11_JAUND_CEOCCUR_6","Jaundice present","Jaundice absent","TcB >= NICE threshold","TcB < NICE threshold")
  ...
  result_birth<-cbind(result_15_NICE_birth,result_Jaund_NICE_birth,result_Jaund_15_birth)
  #PNC-0
  result_15_NICE_0<-result_fun(data,"TCB_threshold_PNC_1_ind","TCB_15_PNC_1_ind","TcB >= 15","TcB < 15","TcB >= NICE threshold","TcB < NICE threshold")
  result_Jaund_NICE_0<-result_fun(data,"TCB_threshold_PNC_1_ind","M13_JAUND_CEOCCUR_7","Jaundice present","Jaundice absent","TcB >= NICE threshold","TcB < NICE threshold")
  result_Jaund_15_0<-result_fun(data,"TCB_15_PNC_1_ind","M13_JAUND_CEOCCUR_7","Jaundice present","Jaundice absent","TcB >= 15","TcB < 15")
  
  #PNC-1
  result_15_NICE_1<-result_fun(data,"TCB_threshold_PNC_2_ind","TCB_15_PNC_2_ind","TcB >= 15","TcB < 15","TcB >= NICE threshold","TcB < NICE threshold")
  result_Jaund_NICE_1<-result_fun(data,"TCB_threshold_PNC_2_ind","M13_JAUND_CEOCCUR_8","Jaundice present","Jaundice absent","TcB >= NICE threshold","TcB < NICE threshold")
  result_Jaund_15_1<-result_fun(data,"TCB_15_PNC_2_ind","M13_JAUND_CEOCCUR_8","Jaundice present","Jaundice absent","TcB >= 15","TcB < 15")
  
  #PNC-4
  result_15_NICE_4<-result_fun(data,"TCB_threshold_PNC_3_ind","TCB_15_PNC_3_ind","TcB >= 15","TcB < 15","TcB >= NICE threshold","TcB < NICE threshold")
  result_Jaund_NICE_4<-result_fun(data,"TCB_threshold_PNC_3_ind","M13_JAUND_CEOCCUR_9","Jaundice present","Jaundice absent","TcB >= NICE threshold","TcB < NICE threshold")
  ...
  write_data_check(wb, "Results", result_15_NICE_birth, startCol = 1, startRow = 1)
  write_data_check(wb, "Results", result_Jaund_NICE_birth, startCol = 1, startRow = 6)
  write_data_check(wb, "Results", result_Jaund_15_birth, startCol = 1, startRow = 11)
  
  write_data_check(wb, "Results", result_15_NICE_0, startCol = 6, startRow = 1)
  write_data_check(wb, "Results", result_Jaund_NICE_0, startCol = 6, startRow = 6)
  write_data_check(wb, "Results", result_Jaund_15_0, startCol = 6, startRow = 11)
  
  write_data_check(wb, "Results", result_15_NICE_1, startCol = 11, startRow = 1)
  write_data_check(wb, "Results", result_Jaund_NICE_1, startCol = 11, startRow = 6)
  write_data_check(wb, "Results", result_Jaund_15_1, startCol = 11, startRow = 11)
  
  write_data_check(wb, "Results", result_15_NICE_4, startCol = 16, startRow = 1)
  write_data_check(wb, "Results", result_Jaund_NICE_4, startCol = 16, startRow = 6)
