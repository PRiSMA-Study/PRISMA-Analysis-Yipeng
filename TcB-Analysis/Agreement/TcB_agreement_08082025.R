...
df_infant_tcb$M11_TBILIRUBIN_UMOLL_LBORRES_6<-ifelse(df_infant_tcb$M11_TBILIRUBIN_UMOLL_LBORRES_6>0 & df_infant_tcb$M11_TBILIRUBIN_UMOLL_LBORRES_6<20,df_infant_tcb$M11_TBILIRUBIN_UMOLL_LBORRES_6,NA)

df_infant_tcb$M14_TCB_UMOLL_LBORRES_7<-ifelse(df_infant_tcb$M14_TCB_UMOLL_LBORRES_7>0 & df_infant_tcb$M14_TCB_UMOLL_LBORRES_7<20,df_infant_tcb$M14_TCB_UMOLL_LBORRES_7,NA)
df_infant_tcb$M14_TCB_UMOLL_LBORRES_8<-ifelse(df_infant_tcb$M14_TCB_UMOLL_LBORRES_8>0 & df_infant_tcb$M14_TCB_UMOLL_LBORRES_8<20,df_infant_tcb$M14_TCB_UMOLL_LBORRES_8,NA)
df_infant_tcb$M14_TCB_UMOLL_LBORRES_9<-ifelse(df_infant_tcb$M14_TCB_UMOLL_LBORRES_9>0 & df_infant_tcb$M14_TCB_UMOLL_LBORRES_9<20,df_infant_tcb$M14_TCB_UMOLL_LBORRES_9,NA)
...
df_infant_tcb <- df_infant_tcb %>%
  mutate(
    jaund_PNC_1 = case_when(
      (M13_JAUND_CEOCCUR_7 == 1 & PNC_age_1 < 24) ~ 1,
      M13_JAUND_CEOCCUR_7 == 0 & M13_JAUND_CESTTIM_7 == 1 ~ 0,
      M13_JAUND_CEOCCUR_7 == 1 & M13_JAUND_CESTTIM_7 == 1 ~ 1,
      ...
      ~ 0,
      M13_JAUND_CEOCCUR_7==1 & (M13_JAUND_CESTTIM_7 != 1 | is.na(M13_JAUND_CESTTIM_7)) ~ 0,
      M13_JAUND_CEOCCUR_7==1 & is.na(PNC_age_1) ~ 0,
      
      TRUE ~ 0
    ),
    jaund_PNC_2 = case_when(
      (M13_JAUND_CEOCCUR_8 == 1 & PNC_age_2 < 24) ~ 1,
      M13_JAUND_CEOCCUR_8 == 0 & M13_JAUND_CESTTIM_8 == 1 ~ 0,
      M13_JAUND_CEOCCUR_8 == 1 & M13_JAUND_CESTTIM_8 == 1 ~ 1,
      ...
      ~ 0,
      M13_JAUND_CEOCCUR_8==1 & (M13_JAUND_CESTTIM_8 != 1 | is.na(M13_JAUND_CESTTIM_8)) ~ 0,
      M13_JAUND_CEOCCUR_8==1 & is.na(PNC_age_2) ~ 0,
      
      TRUE ~ 0
    ),
    jaund_PNC_3 = case_when(
      (M13_JAUND_CEOCCUR_9 == 1 & PNC_age_3 < 24) ~ 1,
      M13_JAUND_CEOCCUR_9 == 0 & M13_JAUND_CESTTIM_9 == 1 ~ 0,
      M13_JAUND_CEOCCUR_9 == 1 & M13_JAUND_CESTTIM_9 == 1 ~ 1,
      ...
      ~ 0,
      M13_JAUND_CEOCCUR_9==1 & (M13_JAUND_CESTTIM_9 != 1 | is.na(M13_JAUND_CESTTIM_9)) ~ 0,
      M13_JAUND_CEOCCUR_9==1 & is.na(PNC_age_3) ~ 0,
      
      TRUE ~ 0
    ),
    jaund_birth_outcome = case_when(
      (M11_JAUND_CEOCCUR_6 == 1 & birth_outcome_age < 24) ~ 1,
      M11_JAUND_CEOCCUR_6 == 0 & M11_BILIRUBIN_LBPERF_6 == 1 ~ 0,
      M11_JAUND_CEOCCUR_6 == 1 & M11_BILIRUBIN_LBPERF_6 == 1 ~ 1,
      ...
      ~ 0,
      M11_JAUND_CEOCCUR_6==1 & (M11_BILIRUBIN_LBPERF_6 != 1 | is.na(M11_BILIRUBIN_LBPERF_6)) ~ 0,
      M11_JAUND_CEOCCUR_6==1 & is.na(birth_outcome_age) ~ 0,
...
df_tcb_long<-df_infant_tcb %>% select("MOMID","PREGID","SITE","INFANTID","M11_TBILIRUBIN_UMOLL_LBORRES_6", "M14_TCB_UMOLL_LBORRES_7", "M14_TCB_UMOLL_LBORRES_8", "jaund_birth_outcome", "jaund_PNC_1", "jaund_PNC_2","TCB_threshold_birth_outcome","TCB_threshold_PNC_1","TCB_threshold_PNC_2") %>%
  pivot_longer(
    cols = c(
      M11_TBILIRUBIN_UMOLL_LBORRES_6, M14_TCB_UMOLL_LBORRES_7, M14_TCB_UMOLL_LBORRES_8,
      jaund_birth_outcome, jaund_PNC_1, jaund_PNC_2,
...
df_tcb_long_threshold_method<-df_tcb_long%>%
  ...
  pivot_longer(
    ...
    strata_id = paste(SITE, INFANTID, visit, sep = "_")
  )
