...
df_infant_tcb <- df_infant_tcb %>%
  mutate(
    ...
    PNC_jaund_ind1 = case_when(
      ...
      ~ 1,
      M13_JAUND_CEOCCUR_7==1 & (M13_JAUND_CESTTIM_7 != 1 | is.na(M13_JAUND_CESTTIM_7)) ~ 1,
      M13_JAUND_CEOCCUR_7==1 & is.na(PNC_age_1) ~ 1,
      TRUE ~ 0
    ),
    PNC_jaund_ind2 = case_when(
      (M13_JAUND_CEOCCUR_8  ==1 & PNC_age_2 >= 24 & PNC_age_2 < (21*24) & M13_YELL_CEOCCUR_8==0)
      ~ 1,
      M13_JAUND_CEOCCUR_8==1 & (M13_JAUND_CESTTIM_8 != 1 | is.na(M13_JAUND_CESTTIM_8)) ~ 1,
      M13_JAUND_CEOCCUR_8==1 & is.na(PNC_age_2) ~ 1,
      TRUE ~ 0
    ),
    PNC_jaund_ind3 = case_when(
      (M13_JAUND_CEOCCUR_9  ==1 & PNC_age_3 >= 24 & PNC_age_3 < (21*24) & M13_YELL_CEOCCUR_9==0)
      ~ 1,
      M13_JAUND_CEOCCUR_9==1 & (M13_JAUND_CESTTIM_9 != 1 | is.na(M13_JAUND_CESTTIM_9)) ~ 1,
      M13_JAUND_CEOCCUR_9==1 & is.na(PNC_age_3) ~ 1,
      TRUE ~ 0
    ),
    birth_outcome_jaund_ind = case_when(
      ...
      ~ 1,
      M11_JAUND_CEOCCUR_6==1 & (M11_BILIRUBIN_LBPERF_6 != 1 | is.na(M11_BILIRUBIN_LBPERF_6)) ~ 1,
      M11_JAUND_CEOCCUR_6==1 & is.na(birth_outcome_age) ~ 1,
      TRUE ~ 0
    ),
  )
...
excel_fun<-function(data){
  ...
  write_data_with_title(wb, "Results", "PNC-1 - Severe Jaundice",     result_PNC1_severe,   11, 1)
