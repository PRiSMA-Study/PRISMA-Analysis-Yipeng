...
write.csv(data.dl.continous,"D:/Users/yipeng_wei/Documents/dl data/2025-10-31/df_dl_continous_transfer.csv")
...
data.static.merge.wide<-data.static %>% 
  mutate(across(-c(SITE, INFANTID, MOMID, PREGID, INF_ASPH, STILLBIRTH_SIGNS_LIFE, SVN, PRETERMBIRTH_LT37, LBW2500_ANY, NEO_DTH, INF_PSBI_OUTCOME, INF_JAUN_NON_SEV_ANY, NEARMISS), 
                ~ ifelse(is.na(.x), 0, .x))) %>%  
...
write.csv(data.dl.continous.wide,"D:/Users/yipeng_wei/Documents/dl data/2025-10-31/df_dl_continous_wide_transfer.csv")

write.csv(data.dl.continous.delta,"D:/Users/yipeng_wei/Documents/dl data/2025-10-31/df_dl_continous_delta_transfer.csv")
write.csv(data.dl.continous.mask,"D:/Users/yipeng_wei/Documents/dl data/2025-10-31/df_dl_continous_mask_transfer.csv")
