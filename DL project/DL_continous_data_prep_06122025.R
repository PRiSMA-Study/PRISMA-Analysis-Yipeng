...
data.enroll <- read.csv("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_ENROLL.csv")%>%select(-"M01_US_OHOSTDAT")
...
df_ultrasound_pre <- merged_df01 %>%
  ...
  mutate(
    across(matches("M01_AFI_PERES_FTS"), ~ transform_continous_to_NA(.)),
...
df_breastfed<-merged_df13%>%select("SITE","SCRNID" ,"MOMID", "PREGID","INFANTID",TYPE_VISIT="M13_TYPE_VISIT","M13_BRSTFEED_EXCL_FAORRES")%>%filter(TYPE_VISIT==7)
...
df_ultrasound <-  df_ultrasound_pre %>%
  ...
  PREVIA= case_when(
    M01_PREVIA_PERES %in% c(2,3) ~ 1,
    M01_PREVIA_PERES == 1 ~ -1,
    TRUE ~ NA_real_
  ))
...
df_inf_outcome<-read.csv("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/INF_OUTCOMES.csv")
data.risk <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_RISKS.dta")
data.demographic<-read.csv("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_DEMOGRAPHIC.csv")
data.infection<-read.csv("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_INFECTION.csv")
data.hemorr <- read.csv("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_HEMORRHAGE.csv")
data.labor <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_LABOR.dta")
data.preterm <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_PRETERM.dta")
data.hdp <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_HDP.dta")
data.gdm <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_GDM.dta")
data.nearmiss <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_NEAR_MISS.dta")
data.depr <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_DEPR.dta")
data.gwg <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/MAT_GWG.dta")
df_inf_anomaly <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/INF_ANOMALY.dta")
df_inf_presentation <- read_dta("D:/Users/yipeng_wei/Documents/dl data/2025-04-18/INF_PRESENTATION.dta")
...
data.static <- df_inf_outcome %>% 
  ...
  mutate(
    ...
    GWG_ADEQUACY_inadequate = ifelse(GWG_ADEQUACY == 0, 1, ifelse(!is.na(GWG_ADEQUACY), -1, NA)),
    GWG_ADEQUACY_adequate = ifelse(GWG_ADEQUACY == 1, 1, ifelse(!is.na(GWG_ADEQUACY), -1, NA)),
    GWG_ADEQUACY_excessive = ifelse(GWG_ADEQUACY == 2, 1, ifelse(!is.na(GWG_ADEQUACY), -1, NA)),
    ...
    STI_POSITIVE_ENROLL = case_when(
      # If any variable is 1 ~ Positive
      rowSums(across(c(
        SYPH_POSITIVE_ENROLL, GON_POSITIVE_ENROLL,
        CHL_POSITIVE_ENROLL, GENU_POSITIVE_ENROLL, OTHR_POSITIVE_ENROLL
      ), ~ .x == 1), na.rm = TRUE) > 0 ~ 1,
    ...
    HIV_POSITIVE_ANY_ANC = case_when(
      HIV_POSITIVE_ANY_ANC == 1 ~ 1,
      HIV_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    
    # Syphilis Positive during ANC
    SYPH_POSITIVE_ANY_ANC = case_when(
      SYPH_POSITIVE_ANY_ANC == 1 ~ 1,
      SYPH_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    
    # Gonorrhea Positive during ANC
    GON_POSITIVE_ANY_ANC = case_when(
      GON_POSITIVE_ANY_ANC == 1 ~ 1,
      GON_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    
    # Chlamydia Positive during ANC
    CHL_POSITIVE_ANY_ANC = case_when(
      CHL_POSITIVE_ANY_ANC == 1 ~ 1,
      CHL_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    
    # Genital Ulcers Positive during ANC
    GENU_POSITIVE_ANY_ANC = case_when(
      GENU_POSITIVE_ANY_ANC == 1 ~ 1,
      GENU_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    
    # Other Infections Positive during ANC
    OTHR_POSITIVE_ANY_ANC = case_when(
      OTHR_POSITIVE_ANY_ANC == 1 ~ 1,
      OTHR_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    
    STI_POSITIVE_ANY_ANC = case_when(
      # If any variable is 1 ~ Positive
      rowSums(across(c(
        SYPH_POSITIVE_ANY_ANC, GON_POSITIVE_ANY_ANC,
        CHL_POSITIVE_ANY_ANC, GENU_POSITIVE_ANY_ANC, OTHR_POSITIVE_ANY_ANC
      ), ~ .x == 1), na.rm = TRUE) > 0 ~ 1,
    ...
    MAL_POSITIVE_ANY_ANC = case_when(
      MAL_POSITIVE_ANY_ANC == 1 ~ 1,
      MAL_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    
    # Hepatitis B Positive during ANC
    HBV_POSITIVE_ANY_ANC = case_when(
      HBV_POSITIVE_ANY_ANC == 1 ~ 1,
      HBV_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    
    # Hepatitis C Positive during ANC
    HCV_POSITIVE_ANY_ANC = case_when(
      HCV_POSITIVE_ANY_ANC == 1 ~ 1,
      HCV_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    
    # Tuberculosis Symptoms Positive during ANC
    TB_SYMP_POSITIVE_ANY_ANC = case_when(
      TB_SYMP_POSITIVE_ANY_ANC == 1 ~ 1,
      TB_SYMP_POSITIVE_ANY_ANC == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    #Hypertension
    HTN = case_when(
    ...
    GES_HTN = case_when(
      HDP_GROUP %in% c(2,3,4,5) ~ 1,
      HDP_GROUP %in% c(0,1) ~ -1,
      TRUE ~ NA_real_
    ),
    #Diabetes
    ...
    BREASTFED = case_when(
      M13_BRSTFEED_EXCL_FAORRES == 1 ~ 1,
      M13_BRSTFEED_EXCL_FAORRES == 0 ~ -1,
      TRUE ~ NA_real_
    ),
    ...
    SVN = case_when(
      ...
      TRUE ~ NA_real_
                  ...
                  "INF_ASPH","STILLBIRTH_SIGNS_LIFE","SVN","INF_PSBI_IPC","PRETERMBIRTH_LT37","NEARMISS","NEO_DTH","LBW2500_ANY","INF_JAUN_NON_SEV_ANY",
                  ...
                  "INF_ANOMALY",
                  "HIV_POSITIVE_ENROLL","SYPH_POSITIVE_ENROLL","GON_POSITIVE_ENROLL","CHL_POSITIVE_ENROLL","GENU_POSITIVE_ENROLL","OTHR_POSITIVE_ENROLL","MAL_POSITIVE_ENROLL","HBV_POSITIVE_ENROLL","HCV_POSITIVE_ENROLL","TB_SYMP_POSITIVE_ENROLL","STI_POSITIVE_ENROLL",
                  "HIV_POSITIVE_ANY_ANC","SYPH_POSITIVE_ANY_ANC","GON_POSITIVE_ANY_ANC","CHL_POSITIVE_ANY_ANC","GENU_POSITIVE_ANY_ANC","OTHR_POSITIVE_ANY_ANC","MAL_POSITIVE_ANY_ANC","HBV_POSITIVE_ANY_ANC","HCV_POSITIVE_ANY_ANC","TB_SYMP_POSITIVE_ANY_ANC","STI_POSITIVE_ANY_ANC")
...
data.static.impute <- data.static %>%
  mutate(across(-c(SITE, INFANTID, MOMID, PREGID, INF_ASPH, STILLBIRTH_SIGNS_LIFE, SVN, PRETERMBIRTH_LT37, LBW2500_ANY, NEO_DTH, INF_PSBI_IPC, INF_JAUN_NON_SEV_ANY, NEARMISS), 
                ~ ifelse(is.na(.x), 0, .x)))
...
write.csv(data.dl.continous,"D:/Users/yipeng_wei/Documents/dl data/2025-04-18/df_dl_continous.csv")
write.csv(data.static,"D:/Users/yipeng_wei/Documents/dl data/2025-04-18/df_dl_static.csv")
...
write.csv(data.temporal.wide,"D:/Users/yipeng_wei/Documents/dl data/2025-04-18/df_dl_temporal_wide.csv")
write.csv(data.dl.continous.wide,"D:/Users/yipeng_wei/Documents/dl data/2025-04-18/df_dl_continous_wide.csv")

write.csv(data.dl.continous.delta,"D:/Users/yipeng_wei/Documents/dl data/2025-04-18/df_dl_continous_delta.csv")
write.csv(data.dl.continous.mask,"D:/Users/yipeng_wei/Documents/dl data/2025-04-18/df_dl_continous_mask.csv")
